...
obj-tables validate ${SCHEMA} hynne.multi.tsv
...
obj-tables validate ${SCHEMA} simple_examples/1.multi.tsv
obj-tables validate ${SCHEMA} simple_examples/2.multi.csv
obj-tables validate ${SCHEMA} simple_examples/3.multi.csv
obj-tables validate ${SCHEMA} simple_examples/4.multi.csv
obj-tables validate ${SCHEMA} simple_examples/5.multi.csv
obj-tables validate ${SCHEMA} simple_examples/6.multi.csv
...
obj-tables validate ${SCHEMA} teusink_model.multi.tsv
obj-tables validate ${SCHEMA} jiang_data.tsv
obj-tables validate ${SCHEMA} jiang_model.multi.tsv
obj-tables validate ${SCHEMA} ecoli_noor_2016_data.tsv
obj-tables validate ${SCHEMA} ecoli_noor_2016_model.multi.tsv
obj-tables validate ${SCHEMA} ecoli_wortel_2018_data.tsv
obj-tables validate ${SCHEMA} ecoli_wortel_2018_model.multi.tsv
obj-tables validate ${SCHEMA} sigurdsson_model.multi.tsv
obj-tables validate ${SCHEMA} layout_model.multi.tsv
