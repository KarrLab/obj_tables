# Schema automatically generated at 2020-03-14 13:01:29
...
class Person(obj_tables.Model):
    ...
    email_adress = obj_tables.EmailAttribute(verbose_name='Email address')
    ...
    class Meta(obj_tables.Model.Meta):
        ...
        attribute_order = ('name', 'type', 'company', 'email_adress', 'phone_number', 'address',)
        verbose_name = 'Person'
