...
class OntologyAttributeTestCase(unittest.TestCase):
    ...
    def test_init(self):
        ...
        attr = obj_tables.ontology.OntologyAttribute(self.ontology, terms=[self.ontology['SBO_0000001']])
        attr = obj_tables.ontology.OntologyAttribute(self.ontology, terms=self.ontology['SBO_0000001'].subclasses())
        ...
        with self.assertRaisesRegex(ValueError, 'must be in `ontology`'):
            attr = obj_tables.ontology.OntologyAttribute(self.ontology, terms=['SBO_0000001'])

        attr = obj_tables.ontology.OntologyAttribute(self.ontology, default=self.term)
        attr = obj_tables.ontology.OntologyAttribute(self.ontology, default=self.term, terms=[self.ontology['SBO_0000000']])
        ...
        with self.assertRaisesRegex(ValueError, 'must be `None` or in `terms`'):
            attr = obj_tables.ontology.OntologyAttribute(self.ontology, default=self.term, terms=[self.ontology['SBO_0000001']])

        attr = obj_tables.ontology.OntologyAttribute(self.ontology, default_cleaned_value=self.term)
        attr = obj_tables.ontology.OntologyAttribute(self.ontology, default_cleaned_value=self.term, terms=[self.ontology['SBO_0000000']])
        with self.assertRaisesRegex(ValueError, 'must be `None` or in `terms`'):
    ...
    def test_clean(self):
        ...
        attr = obj_tables.ontology.OntologyAttribute(self.ontology, namespace='SBO', namespace_sep='_')
